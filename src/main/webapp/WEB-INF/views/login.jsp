...
<div class="content">
	...
	<form class="login-form" action="rest/user/login" method="post">
		...
		<div class="forget-password">
			<h4>忘记密码 ? </h4>
			<p>
				不要担心，点击 <a href="javascript:;" id="forget-password">这里</a> 重置您的密码.
			</p>
		</div>
	...
	<form class="register-form" action="rest/user/register" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" name="rusername" id="register_username"/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">密码</label>
			<div class="input-icon">
				<i class="fa fa-lock"></i>
				<input class="form-control placeholder-no-fix" type="password" data-required="1" autocomplete="off" id="register_password" placeholder="密码" name="passwords"/>
			</div>
		</div>
		<div class="form-group">
