    ...
    <div class="portlet-body form">
        ...
        <form action="#" id="roleform" class="form-horizontal">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">用户标识<span class="required">
                                            * </span>
                    </label>
                    <div class="col-md-4">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-3 col-md-9">
                        <button type="submit" class="btn red" id="loginBut">添加</button>
...
<script type="text/javascript" src="app/js/addrole.js"></script>
<script>
