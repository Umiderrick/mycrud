    ...
    return {
        init: function () {
                ...
                "aoColumnDefs":[
                    ...
                    },
                    {
                        ...
                        "mRender": function (data, type, full) {
                            return "<a class=\"edit\" href=\"/rest/page/edituser\">" + "编辑" + "</a>"; //(7) 设置“编辑”超链接
                        }
                    },
                    {
                        "aTargets": [5],
                    ...
                    },
                    {
                        "aTargets": [6],
                        "mRender": function (data, type, full) {
                            return "<a class=\"btn btn-info\" >" + "绑定角色" + "</a>";
                        }
                    }
                ],
                // m410,特别要求
            ...
            function fnRefresh() {
                ...
                $('#tbu a.delete').on('click', function (e) {
                    e.preventDefault();
                    var nRow = $(this).parents('tr')[0];
                    var aData = oTable.fnGetData(nRow);
                    $.ajax({
                        url: "rest/page/deleteuser/"+aData[0],
                        type: 'delete',
                        async: false,
            ...
            function retrieveData(sSource2, aoData2, fnCallback2) {
                ...
                $.ajax({
                    url: "rest/page/datausertableajax",
