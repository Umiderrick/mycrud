    ...
    <div class="portlet-body form">
        ...
        <form action="#" id="roleform2" class="form-horizontal">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">角色名<span class="required">
                                            * </span>
                    </label>
                    <div class="col-md-4">
                        <input type="text" name="roleName" data-required="1" class="form-control" value="<%=request.getParameter("number2")%>"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">角色标识<span class="required">
                                            * </span>
                    </label>
                    <div class="col-md-4">
                        <input type="text" name="roleSign" data-required="1" class="form-control"/>
                    </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript" src="app/js/editrole.js"></script>